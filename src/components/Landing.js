  ...
  return (
    <div className="LandingPage grid place-content-center">
        <div className="px-5 py-2 bg-slate-800 border-2 border-indigo-400 rounded-tr-md rounded-bl-md mx-5">
          <h1 className="bg-clip-text text-transparent bg-gradient-to-r from-pink-300 to-violet-400 font-bold text-center text-lg md:text-2xl">Welcome to E-Todo App Your personal Todo List</h1>
        </div>
